...
Se eu pedir para a IA configurar uma VPC, ela vai me dar um bloco CIDR. Se eu não souber os fundamentos de redes e *subnetting*, eu vou simplesmente copiar e colar. Meses depois, o Auto-scaling precisa subir novos *pods* e não consegue porque os IPs acabaram. 
